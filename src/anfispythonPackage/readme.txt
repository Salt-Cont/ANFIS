...
2. Installing the anfis Package

A. Change to the directory that contains the file setup.py and the subdirectory anfis. If 
...
3. Using the anfis Package

The anfis package is on your Python path. To import it into a Python script or session, 
execute:
